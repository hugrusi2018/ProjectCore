...
namespace ProjectCore.DAL.Models
{
    public partial class ProjectCoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-N8RE2K9\\SQLEXPRESS;Database=ProjectCore;User ID=UserProjectCore;Password=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUsers>(entity =>
            {
                ...
                entity.HasOne(d => d.Tenant)
                    ...
                    .HasConstraintName("FK__AspNetUse__Tenan__6FE99F9F");
            });
            ...
            modelBuilder.Entity<Members>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Members__UserId__6EF57B66");
            });
            ...
            modelBuilder.Entity<UserProjects>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserProjects)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__UserProje__UserI__6E01572D");
            });
        }
    }
}
